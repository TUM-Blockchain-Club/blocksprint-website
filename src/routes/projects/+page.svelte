...
>
	...
	>
		...
		Following the impactful 2nd iteration, the 3rd iteration is currently underway, driving innovation 
		and bridging academia with the blockchain industry.
	</p>
</div>
	...
	<div class="grid grid-cols-1 gap-[1px] bg-zinc-900 sm:grid-cols-2">
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				...
				<br /><br />
				The project team develops AI solutions to enhance the offering of StableLab
				 and actively contributes to the future of DAO governance.
			</p>
			<Button
		...
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				...
				<br /><br />
				Ambitious students build a user-friendly mobile blockchain explorer, 
				provide real-time insights into Solana activity, and enhance community engagement.
			</p>
			<Button
		...
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				...
				testnet.
				<br /><br />
				A dedicated team analyzes and deploys Crypto Agents, 
				contributing to AI-driven blockchain security and automation.
			</p>
			<Button
		...
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				...
				<br /><br />
				The team designs and deploys blockchain testing infrastructure in a Munich data center, 
				focusing on hardware configuration, network optimization, and blockchain environment testing.
			</p>
			<Button
		...
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			<div class="flex w-fit">
				<div class="-m-0.5">
					<img src={hauck} alt="Hauck Aufhäuser" class="h-8" />
				</div>
			</div>
...
>
	...
	<div class="grid grid-cols-1 gap-[1px] bg-zinc-900 sm:grid-cols-2">
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				Building a decentralized marketplace framework for engineering artifacts.
				<br /><br />
				The team helped Bosch to overcome the limitations in data acquisition and model access during the 
				verification and validation stage, where hardware and software were tested in simulation.
			</p>
			<Button
				href="https://tum-blockchain.notion.site/Bosch-Decentralized-Marketplace-for-Automotive-Testing-60c0aab136e544959f67a023c9af5f9e"
				target="_blank"
				rel="noopener"
				class="w-fit text-sm"
				variant="secondary">Learn More</Button
		...
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				As crypto and digital assets continue to rise, WM Datenservice sees a transformative
				opportunity.
				<br /><br />
				A dedicated team of ambitious students delved deep into the world of crypto data, 
				identifying innovative products or services that could shape the future of finance.
			</p>
			<Button
				href="https://tum-blockchain.notion.site/WM-Datenservice-DeFi-Market-Research-eb9cc8fc6b194f178ab399868a9a2632"
				target="_blank"
				rel="noopener"
				class="w-fit text-sm"
				variant="secondary">Learn More</Button
		...
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				Do you excel at organizing events and have a talent for creating and contributing to
				communities?
				<br /><br />
				The team worked alongside contributors from 
				Superteam Germany and helped grow the Web3 Solana community locally and globally.
			</p>
			<Button
				href="https://tum-blockchain.notion.site/Superteam-Project-296f911e23f54e099aa91490f1be8935"
				target="_blank"
				rel="noopener"
				class="w-fit text-sm"
				variant="secondary">Learn More</Button
		...
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				Currently in Solana, shifting stakes between validators is too time-consuming.
				<br /><br />
				The project team developed a layer on top of Solana's native staking, 
				enabling users to seamlessly shift stakes in just one transaction.
			</p>
			<Button
				href="https://tum-blockchain.notion.site/Solana-Beach-Fast-Stake-Shift-Project-a2c948f1673f41d0830bc94c2f743f17"
				target="_blank"
				rel="noopener"
				class="w-fit text-sm"
				variant="secondary">Learn More</Button
...
>
	...
	<div class="grid grid-cols-1 gap-[1px] bg-zinc-900 sm:grid-cols-2">
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				Europe's Digital Product Passport (DPP) aims to improve the sustainability of products such
				as EV batteries and will be mandatory starting in 2027.
				<br /><br />
				The project team explored opportunities to implement the DPP with blockchain technology and 
				successfully implemented it on a blockchain with privacy in mind.
			</p>
			<Button
				href="https://drive.google.com/file/d/1b_TMZREmEgL7LebQyJG_g2nz-G8G-6ZU/view"
				target="_blank"
				rel="noopener"
				class="w-fit text-sm"
				variant="secondary">Learn More</Button
		...
		<div class="items-left flex flex-col gap-5 bg-zinc-950 px-3 py-10 sm:p-10">
			...
			<p class="text max-w-md text-sm text-muted-foreground sm:text-base md:text-lg">
				Solana Beach is a platform for exploring the Solana blockchain, offering insights into
				statistics, validators, token metrics, and news about the ecosystem.
				<br /><br />
				The team dived deep into the code of the Solana Labs Client, 
				extracted and categorized relevant parameters, and evaluated optimization potential by finetuning parameters.
			</p>
			<Button
				href="https://docs.google.com/presentation/d/1XU-n3fTOR0Pr5ouDvQflQSCauU_MHcriMMExMMc_3VI/edit#slide=id.g2bfb78af382_0_2035"
				target="_blank"
				rel="noopener"
				class="w-fit text-sm"
				variant="secondary">Learn More</Button
